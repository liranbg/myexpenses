				...
				<Menu pointing secondary>
					<Container>
						...
						{profile.isLoaded &&
							!profile.isEmpty && (
								<MenuItem>
									<Dropdown icon={<Image centered avatar src={profile.photoURL} title={profile.email} />}>
										<DropdownMenu
											style={{
												marginTop: 12
											}}
										>
											<Dropdown.Header>Hey {profile.displayName},</Dropdown.Header>
											<DropdownItem content="SignOut" onClick={this.handleSignOut} />
										</DropdownMenu>
									</Dropdown>
								</MenuItem>
							)}
